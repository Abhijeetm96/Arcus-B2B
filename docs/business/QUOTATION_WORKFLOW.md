...
---
◀️ **[Previous](RFQ_WORKFLOW.md)** | 🔼 **[Parent Section](../README.md)** | **[Next](BUILDPOINTS.md)** ▶️
---



This document describes the quotation lifecycle, negotiation, and admin approval workflows.
