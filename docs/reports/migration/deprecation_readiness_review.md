...
* **Service Classes**:
  * [UserService.ts](../../../server/src/modules/users/UserService.ts#L60-L72) (handles DB mappings).
* **Frontend Pages**:
...
* **Service Classes**:
  * [UserService.ts](../../../server/src/modules/users/UserService.ts#L71)
* **Frontend Pages**:
...
* **Service Classes**:
  * [ProductService.ts](../../../server/src/modules/catalog/ProductService.ts) (reads and stringifies JSONB arrays).
  * [InventoryService.ts](../../../server/src/modules/inventory/InventoryService.ts) (reads and updates flat product stock).
* **Frontend Pages**:
...
* **Service Classes**:
  * [OrderService.ts](../../../server/src/modules/orders/OrderService.ts) (parses JSONB item arrays).
* **Frontend Pages**:
